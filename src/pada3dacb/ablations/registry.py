...
_BASE_MODEL = ModelVariant(name="PADA-3DACB", aggregator="AttentionAggregator")
_MEAN_MODEL = ModelVariant(name="PADA-3DACB+MeanPoolAggregator", aggregator="MeanPoolAggregator")
...
_SPECS = (
    ...
    _blocked(
        ...
        "current PADA-3DACB already is the explicit no-context architecture; identity patching Full is forbidden",
        NotebookProvenance("notebooks/archive/training_original.ipynb", 19, "39-44"),
        equivalent_method="PADA-3DACB",
    ),
    _blocked(
        "identity_ctx",
