...
from pada3dacb.data.derivative_verification import numerical_summary
from pada3dacb.data.inventories import SelectedScan, discover_and_select, sanitize_id
...
def _numerical_cfg() -> Any:
    from pada3dacb.data.derivative_verification import VerificationConfig
