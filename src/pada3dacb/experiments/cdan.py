"""Configuration and orchestration for PADA-3DACB + CDAN."""
...
from pada3dacb.experiments.runner import FoldExecutionResult, SourceOnlyExperimentRunner
from pada3dacb.experiments.source_only import SourceOnlyExperimentConfig, load_source_only_config

CDAN_DISPLAY_NAME = "PADA-3DACB + CDAN"
...
def load_cdan_config(path: str | Path, *, overrides: dict[str, Any] | None = None) -> CDANExperimentConfig:
    ...
    if raw_model.get("contextual_encoder") is not False:
        raise ConfigurationError("Phase 12 CDAN requires contextual_encoder=false for the public PADA-3DACB model.")
