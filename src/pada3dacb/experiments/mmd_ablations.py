...
from pada3dacb.binary import MMDBinaryAblationPlan, mmd_binary_ablation_plan
...
class BinaryMMDAblationComposition:
    ...
    def model_variant(self) -> str:
        return "PADA-3DACB+MeanPoolAggregator" if self.plan.model_variant == "mean_pool" else "PADA-3DACB"

    def build_loss(self, num_rois: int) -> CorePADA3DACBLoss:
