"""Configuration and immutable run identity for 3D-ACDA + CORAL."""
...
from acda3d.data.datasets import TargetAdaptationDataset
...
from acda3d.data.records import requirement_profile
...
from acda3d.experiments.runner import (
    FoldExecutionResult,
    PreparedFold,
...
CORAL_DISPLAY_NAME = "3D-ACDA + CORAL"
