...
from acda3d.data.records import CLASS_ORDER
from acda3d.exceptions import ExperimentValidationError
from acda3d.training.runtime import move_batch, require_batch_keys
...
def collect_predictions(
    ...
    *,
    ...
    model_name: str = "3D-ACDA Source-Only",
) -> pd.DataFrame:
...
def validate_binary_prediction_frame(frame: pd.DataFrame) -> None:
    ...
    from acda3d.binary import BinaryLabelError, validate_binary_prediction
...
def binary_prediction_metrics(frame: pd.DataFrame) -> dict[str, dict[str, object]]:
    from acda3d.binary import evaluate_binary_predictions
...
def task_scoped_binary_prediction_from_logits(
    ...
    from acda3d.binary import binary_prediction_from_logits
