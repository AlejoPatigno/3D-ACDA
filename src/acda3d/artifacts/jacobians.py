...
from acda3d.artifacts.atlas import AtlasROIManager, validate_atlas_grid
from acda3d.artifacts.concepts import save_plain_mri_pt
from acda3d.artifacts.regional_features import masked_mean_pool
from acda3d.exceptions import MissingOptionalDependencyError
...
def _require_sitk() -> Any:
    if sitk is None:
        raise MissingOptionalDependencyError("SimpleITK is required for canonical Jacobian computation. Install acda3d[full].")
    return sitk
