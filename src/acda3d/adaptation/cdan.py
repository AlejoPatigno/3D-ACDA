"""Exact outer-product CDAN over latent 3D-ACDA embeddings."""
...
from acda3d.adaptation.domain_discriminator import DomainDiscriminator
from acda3d.adaptation.gradient_reversal import gradient_reverse
...
class CDANAdaptationMethod:
    ...
    def compute(self, source_output: ACDA3DOutput, target_output: ACDA3DOutput, stage: str) -> AdaptationLossOutput:
