...
if TYPE_CHECKING:
    from acda3d.ablations.resolver import ResolvedAblationConfig

from acda3d.adaptation import AdaptationMethod
...
from acda3d.binary import apply_binary_ablation_loss_plan, binary_ablation_plan
from acda3d.exceptions import PhaseNotImplementedError, TrainingRuntimeError
from acda3d.losses.outputs import CoreLossOutput
from acda3d.training.checkpointing import configuration_hash
...
def _validate_loss_contract(contract: ResolvedAblationConfig) -> None:
    from acda3d.ablations.schemas import InterventionKind
