...
constructs the retained 3D-ACDA architecture with an explicit two-class task
...
from acda3d.adaptation.cdan import (
    CDANAdaptationMethod,
    conditional_outer_product,
    expected_conditional_dimension,
)
from acda3d.adaptation.domain_discriminator import (
    DomainDiscriminator,
...
from acda3d.models.acda3d import ACDA3DOutput, build_acda3d
...
class BinaryPublicationConfig:
    ...
    def from_mapping(
        ...
        if model.get("name") != "3D-ACDA" or model.get("num_classes") != 2:
            raise ConfigurationError(
                "Binary publication runtime requires 3D-ACDA with num_classes=2; "
...
class BinaryPublicationRuntime:
    ...
    def _synthetic_outputs(self) -> tuple[ACDA3DOutput, ACDA3DOutput]:
        torch.manual_seed(18_002)
        model = build_acda3d(self._model_payload())
        model.eval()
    ...
    @staticmethod
    def _shape_result(
        method: str, source: ACDA3DOutput, *, z_dimension: int
    ) -> dict[str, Any]:
        return {
            "method": method,
    ...
    def validate_method(self, method: str) -> dict[str, Any]:
        ...
        if method == "source_only":
            ...
            from acda3d.adaptation.coral import CORALAdaptationMethod
            ...
            from acda3d.adaptation.mmd import MMDAdaptationMethod
...
def select_binary_checkpoint(candidates: Any) -> Mapping[str, Any]:
    ...
    from acda3d.binary import select_best_checkpoint_by_source_validation_macro_f1
